        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-6">
            ...
            <div className="max-w-3xl mx-auto">
              ...
              >
                <p className="text-sm md:text-base text-[#4B5563] mb-3">
                ...
                <div className="grid grid-cols-3 gap-4 mt-6">
                  <div className="text-center">
                    <div className="inline-flex items-center justify-center w-14 h-14 rounded-full bg-[#E34234]/10 text-[#E34234] mb-2">
        ...
        <section className="py-12 bg-white">
          <div className="container mx-auto px-6 text-center">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 sm:gap-6 mt-8">
              <Link 
                href="/how-it-works" 
                className="px-6 py-2 rounded-full bg-gray-100 text-[#0A0A0A] border border-gray-200 hover:bg-gray-200 transition-colors font-medium text-sm"
              >
                How It Works
              </Link>
              <Link 
                href="/designer" 
                className="px-6 py-2 rounded-full bg-[#E34234] text-white hover:bg-opacity-90 transition-colors font-medium text-sm flex items-center justify-center gap-2"
              >
                Start Designing
