...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between bg-[var(--nike-gray-light)] border-0 px-4 py-2 text-sm text-[var(--nike-black)] font-medium ring-offset-background placeholder:text-[var(--nike-gray-medium)] focus:outline-none focus:ring-1 focus:ring-[var(--nike-black)] focus:ring-offset-1 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1",
      className
    )}
    {...props}
  >
    ...
    <SelectPrimitive.Icon asChild>
      <ChevronDown className="h-4 w-4 text-[var(--nike-gray-dark)]" />
