...
import { CrownIcon, Menu, X, Moon, User, UserCircle } from "lucide-react";
...
export default function Navbar() {
  ...
  // Handle scroll event for adding shadow on scroll
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <nav className={`bg-white/90 backdrop-blur-md border-b border-gray-200 sticky top-0 z-50 ${scrolled ? 'shadow-sm' : ''} transition-shadow duration-300`}>
      ...
      {isMenuOpen && (
        <div className="md:hidden fixed inset-0 z-50 bg-white pt-14">
          <div className="px-5 pt-3 pb-4 h-full overflow-y-auto">
